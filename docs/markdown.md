...
### :information_source: ch-md-info-try-typora
...
### :information_source: ch-md-info-try-marktext
...
### :information_source: ch-md-info-use-vs-code
...
### :warning: ch-md-warning-file-name-case
...
### :warning: ch-md-warning-emphasis-punctuation
...
### :no_entry: ch-md-error-separate-blocks
...
### :no_entry: ch-md-error-line-length
...
### :no_entry: ch-md-error-new-line-sentence
...
### :no_entry: ch-md-error-italic-style
...
### :no_entry: ch-md-error-bold-style
...
### :no_entry: ch-md-error-eof

Документ должен заканчиваться пустой строкой.

## Heading

### :no_entry: ch-md-error-first-line-h1
...
### :no_entry: ch-md-error-heading-style
...
### :no_entry: ch-md-error-trailing-punctuation-in-heading
...
### :no_entry: ch-md-error-increment-heading-levels
...
### :no_entry: ch-md-error-emphasis-instead-of-a-heading
...
!!! success "Отлично"
    ...
    [google]: https://www.google.com
    ```
### :no_entry: ch-md-error-new-line-url
...
### :no_entry: ch-md-error-ul-indentation
...
### :warning: ch-md-warning-code-blocks-style
...
### :no_entry: ch-md-error-code-blocks-language
...
### :warning: ch-md-warning-image-file-name-case
...
### :warning: ch-md-warning-image-base-format
...
### :no_entry: ch-md-error-image-alt-text
...
### :no_entry: ch-md-error-image-location
